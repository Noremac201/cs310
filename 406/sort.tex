...
\begin{picture}(7200.00,5040.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \put(2980,1720){\rotatebox{31}{\makebox(0,0)[l]{\strut{}$\frac{5}{2} \log(n)$}}}%
      \put(3526,1480){\rotatebox{27}{\makebox(0,0)[l]{\strut{}$2 \log(n)$}}}%
    }%
    \gplgaddtomacro\gplfronttext{%
      \csname LTb\endcsname%
      \put(176,2541){\rotatebox{-270}{\makebox(0,0){\strut{}Operation Count}}}%
      \put(4072,154){\makebox(0,0){\strut{}Input Size}}%
      \put(4072,4709){\makebox(0,0){\strut{}Empirical Analysis of Heap Sort Algorithm}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics{sort}}%
    \gplfronttext
  \end{picture}%
\endgroup
